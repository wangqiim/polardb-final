...
#ifndef __blizzard_hashtable_h__
#define __blizzard_hashtable_h__
...
int32_t hashtable_put(struct hashtable *ht, const char *key, uint64_t val);

// get an object by key
uint64_t hashtable_get(struct hashtable *ht, const char *key);

// get an object by index
uint64_t hashtable_getidx(struct hashtable *ht, int32_t idx);
